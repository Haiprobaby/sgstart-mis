...
class CustomResultSettingController extends Controller
{
    ...
    public function store(request $request)
    {
        ...
        try {
            ...
            $check_exist = CustomResultSetting::where('academic_year', '=', $system_setting)->first();
            if ($check_exist == '') {
                ...
                $custom_setting = CustomResultSetting::where('academic_year', '=', $system_setting)->first();
                $custom_setting->exam_term_id1 = $request->exam_term1;
                $custom_setting->exam_term_id2 = $request->exam_term2;
                $custom_setting->exam_term_id3 = $request->exam_term3;
                $custom_setting->percentage1 = $request->percentage_ex_1;
    ...
    {
        try {
            $marks_gpa = DB::table('sm_marks_grades')->where('from', '<=', $marks)->where('up', '>=', $marks)->first();
    ...
    public function meritListReport(Request $request)
    {
        ...
        try {
            ...
            $class_name=$class->class_name;
                ...
                $customresult = SmCustomTemporaryResult::orderBy('final_result', 'DESC')->get();
