...
class SmExaminationController extends Controller
{
    ...
    public function viewExamSchedule($class_id, $section_id, $exam_id)
    {
        try{
            ...
            $assign_subjects = SmExamScheduleSubject::where('exam_schedule_id', $exam_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function viewExamStatus($exam_id)
    {
        try{
            ...
            $view_exams = SmExamSchedule::where('exam_id', $exam_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function exam_type_edit($id)
    {
        try{
            ...
            $exams_types = SmExamType::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function seatPlanCreate()
    {
        try{
            ...
            $classes = SmClass::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $subjects = SmSubject::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $class_rooms = SmClassRoom::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function seatPlanSearch(Request $request)
    {
       ...
       try{
            ...
            foreach ($class_rooms as $class_room) {
                $assigned_student = SmSeatPlanChild::where('room_id', $class_room->id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function seatPlanReportSearch(Request $request)
    {
      try{
            ...
            $seat_plans = $seat_plans->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function make_merit_list($InputClassId, $InputSectionId, $InputExamId, Request $request)
    {
        ...
        $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            $data = [];
            $data['exams'] = $exams->toArray();
            $data['classes'] = $classes->toArray();
    ...
    public function meritListReportSearch(Request $request)
    {
        ...
        //    dd( $is_data);
            ...
            $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where('exam_id','=',$InputExamId)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function meritListPrint($exam_id, $class_id, $section_id)
    {
        ...
        //$subjectlist = explode(',', $first_data->subjects_string);
        // $allresult_data = SmTemporaryMeritlist::orderBy('gpa_point', 'desc')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        // $merit_serial = 1;
        // foreach ($allresult_data as $row) {
        ...
        $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where(['exam_id'=>$exam_id,'class_id'=>$class_id,'section_id'=>$section_id])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
        // $allresult_data = SmTemporaryMeritlist::orderBy('merit_order', 'asc')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function markSheetReportSearch(Request $request)
    {
        ...
        try{
            ...
            $all_students = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            $marks_registers = SmMarksRegister::where('exam_id', $request->exam)->where('class_id', $request->class)->where('section_id', $request->section)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function markSheetReportStudentPrint($exam_id, $class_id, $section_id, $student_id)
    {
       try{
        ...
        $subjects = SmAssignSubject::where([['class_id', $class_id], ['section_id', $section_id]])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
