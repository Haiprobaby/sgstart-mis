...
class SmHomeworkController extends Controller
{
    ...
    public function saveHomeworkData(Request $request)
    {
        ...
        try {
            ...
            $students = SmStudent::select('id')->where('class_id', $request->class_id)->where('section_id', $request->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function evaluationHomework(Request $request, $class_id, $section_id, $homework_id)
    {
        ...
        try {
            ...
            $students = SmStudent::where('class_id', '=', $class_id)->where('section_id', '=', $section_id)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function searchEvaluation(Request $request)
    {
        ...
        try {
            $homeworkLists = SmHomework::where('active_status', '=', '1')->where('subject_id', '=', $request->subject_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function viewEvaluationReport($homework_id)
    {
        ...
        try {
            ...
            $homework_students = SmHomeworkStudent::where('homework_id', $homework_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function homeworkEdit($id)
    {
        ...
        try {
            ...
            $classes = SmClass::where('active_status', '=', '1')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $sections = SmClassSection::where('class_id', '=', $homeworkList->class_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            $subjects = SmAssignSubject::where('class_id', $homeworkList->class_id)->where('section_id', $homeworkList->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
