...
class SmQuestionBankController extends Controller
{
    ...
    {       
        try{
            $levels = SmQuestionLevel::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $groups = SmQuestionGroup::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $banks = SmQuestionBank::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    {
        try {
            $levels = SmQuestionLevel::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $groups = SmQuestionGroup::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $banks = SmQuestionBank::where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
