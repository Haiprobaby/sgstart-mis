 ...
 */
    ...
    public function deleteStaff($id)
    {
        ...
        try{
            $tables1 = tableList::getTableList('assign_class_teacher_id', $id); 
            $tables2 = tableList::getTableList('teacher_id', $id);
            $tables3 = tableList::getTableList('evaluated_by', $id);
            $tables4 = tableList::getTableList('staff_id', $id);
            try {
