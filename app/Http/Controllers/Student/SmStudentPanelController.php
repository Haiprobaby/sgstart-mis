...
class SmStudentPanelController extends Controller
{
    ...
    public function studentMyAttendanceSearch(Request $request, $id = null)
    {
        ...
        try {
            ...
            $attendances = SmStudentAttendance::where('student_id', $student_detail->id)->where('attendance_date', 'like', $request->year . '-' . $request->month . '%')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function studentMyAttendancePrint($month, $year)
    {
        try {
            ...
            $attendances = SmStudentAttendance::where('student_id', $student_detail->id)->where('attendance_date', 'like', $year . '-' . $month . '%')->get();
    ...
    public function studentProfile(Request $request, $id = null)
    {
        ...
        try {
            ...
            $totalSubjects = SmAssignSubject::where('class_id', '=', $student_detail->class_id)->where('section_id', '=', $student_detail->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $totalNotices = SmNoticeBoard::where('active_status', '=', 1)->where('is_published', '=', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            $now = date('H:i:s');
            $online_exams = SmOnlineExam::where('active_status', 1)->where('status', 1)->where('class_id', $student_detail->class_id)->where('section_id', $student_detail->section_id)->where('date', 'like', date('Y-m-d'))->where('start_time', '<', $now)->where('end_time', '>', $now)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $teachers = SmAssignSubject::select('teacher_id')->where('class_id', $student_detail->class_id)
                ->where('section_id', $student_detail->section_id)->distinct('teacher_id')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();

            $issueBooks = SmBookIssue::where('member_id', $student_detail->user_id)->where('issue_status', 'I')->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            ...
            return view('backEnd.studentPanel.studentProfile', compact('totalSubjects', 'totalNotices', 'online_exams', 'teachers', 'issueBooks', 'homeworkLists', 'attendances', 'driver', 'student_detail', 'fees_assigneds', 'fees_discounts', 'exams', 'documents', 'timelines', 'siblings', 'grades'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function studentViewExamSchedule($id)
    {
        try {
            ...
            $assign_subjects = SmExamScheduleSubject::where('exam_schedule_id', $id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function studentSubject()
    {
        try {
            $user = Auth::user();
            $student_detail = SmStudent::where('user_id', $user->id)->first();
            $assignSubjects = SmAssignSubject::where('class_id', $student_detail->class_id)->where('section_id', $student_detail->section_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    public function studentTransport()
    {
        try {
            ...
            //     ->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            //$vehicles = SmAssignVehicle::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
    ...
    function leaveApply(Request $request)
    {
        try {
            ...
            if ($user) {
                $my_leaves = SmLeaveDefine::where('role_id', $user->role_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                $apply_leaves = SmLeaveRequest::where('role_id', $user->role_id)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                $leave_types = SmLeaveDefine::where('role_id', $user->role_id)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            } else {
                $my_leaves = SmLeaveDefine::where('role_id', $request->role_id)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                $apply_leaves = SmLeaveRequest::where('role_id', $request->role_id)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
                $leave_types = SmLeaveDefine::where('role_id', $request->role_id)->where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            }
    ...
    {
        try {
            $apply_leaves = SmLeaveRequest::where([['active_status', 1], ['approve_status', 'P']])->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $leave_types = SmLeaveType::where('active_status', 1)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $roles = Role::where('id', 2)->where('created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            $pendingRequest = SmLeaveRequest::where('sm_leave_requests.active_status', 1)
                ...
                ->where('sm_leave_requests.created_at', 'LIKE', '%' . YearCheck::getYear() . '%')->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                $data = [];
