                        ...
                        <tr style="border-right: 1px solid #ddd; border-left: 1px solid #ddd;  height: 100px; ">
                            <td colspan="3" style=" position: relative; text-align: center; background-color: #c738d8; border:1px solid #c738d8">
                               <!--  <center>
                                ...
                                <h3 style="padding: 5px; text-align: center; margin-bottom: 20px;  color: #fff; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; ">@lang('lang.view') @lang('lang.student_id_card')</h3>
                            </td>
                        </tr>
                        {{--  <tr >
