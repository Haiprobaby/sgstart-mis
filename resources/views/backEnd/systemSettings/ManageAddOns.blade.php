                    ...
                    <div class="col-lg-12">
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td> 
                                    {{-- <a  class="primary-btn small bg-success text-white border-0" href="{{@$row['url']}}" target="_blank" >
                                        @lang('lang.buy')  @lang('lang.now')
                                    </a>  --}}
                                    <a  class="primary-btn fix-gr-bg small" href="{{@$row['url']}}" target="_blank" >
                                        @lang('lang.buy')  @lang('lang.now')
                                    </a> 
                                    </td> 
                                </tr> 
                        ...
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td>
                                    {{-- {{dd(url($path))}} --}}
                                    @if(@$row->isDisabled())
                                        <a  class="primary-btn small {{@$row->getName()}} bg-warning text-white border-0" href="#"  >
                                            @lang('lang.disable')
                                        </a>
                                    @else 
                                        <a  class="primary-btn small {{@$row->getName()}} bg-success text-white border-0" href="#"  >
                                            @lang('lang.enable')
                                        </a>
                                    @endif
                                    </td>
