...
// });
    ...
    Route::group(['middleware' => ['XSS']], function () {
        ...
        Route::get('details/{id}','SmFrontendController@getdetails');//view admission by id
     ...
     */
        ...
        // Ajax Edit fees routes
        Route::post('edit-discount','AjaxEditController@editdiscount');

        Route::post('add-discount','AjaxEditController@adddiscount');
        //Phạm Trọng Hải
