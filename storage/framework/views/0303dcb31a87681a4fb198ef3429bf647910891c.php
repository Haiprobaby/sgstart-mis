                        ...
                        <div class="in_login_page_iner">
                            <div class="in_login_page_header">
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="<?php echo app('translator')->getFromJson('lang.enter'); ?> <?php echo app('translator')->getFromJson('lang.email'); ?>" name="email" class="<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>">
...
<?php /**PATH C:\wamp64\www\Mis-Saigonstar\resources\views/auth/loginCodeCanyon.blade.php ENDPATH**/ ?>