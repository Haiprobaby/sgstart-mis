                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr id="<?php echo e(@$value->id); ?>">
                                ...
                                <td>
                                    <label class="switch">
                                      <input type="checkbox" class="switch-input-staff" <?php echo e(@$value->active_status == 0? '':'checked'); ?>>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mis-Saigonstar\resources\views/backEnd/humanResource/staff_list.blade.php ENDPATH**/ ?>